...
public class OrderItem extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3002767899457033356L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderItem\",\"namespace\":\"com.ecommerce.app.kafka.warehouse.avro.model\",\"fields\":[{\"name\":\"productId\",\"type\":{\"type\":\"string\",\"logicalType\":\"uuid\"}},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public OrderItem(java.util.UUID productId, java.lang.Integer quantity) {
   ...
   */
  public static com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder newBuilder() {
    return new com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder();
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder newBuilder(com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder other) {
    if (other == null) {
      return new com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder();
    } else {
      return new com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder(other);
    }
  }
   ...
   * @return A new OrderItem RecordBuilder
   */
  public static com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder newBuilder(com.ecommerce.app.kafka.warehouse.avro.model.OrderItem other) {
    if (other == null) {
      return new com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder();
    } else {
      return new com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderItem>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.ecommerce.app.kafka.warehouse.avro.model.OrderItem other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.productId)) {
        this.productId = data().deepCopy(fields()[0].schema(), other.productId);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder setProductId(java.util.UUID value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder clearProductId() {
      productId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.ecommerce.app.kafka.warehouse.avro.model.OrderItem.Builder clearQuantity() {
